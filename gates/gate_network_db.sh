...
INSTANCE_ID="i-0910f11855ce0e894"
DB_ID="lab3/rds/mysql"                   # RDS DBInstanceIdentifier
DB_PORT="3306"               # optional override
OUT_JSON="${OUT_JSON:-gate_result.json}"

CHECK_PRIVATE_SUBNETS="true"  # true/false
...
usage() {
  cat <<EOF
Usage:
  REGION=us-east-1 INSTANCE_ID=i-0910f11855ce0e894 DB_ID=lab-mysql ./gate_network_db.sh
